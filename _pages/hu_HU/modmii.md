...
| H = HackMii Solutions Wizard (Fejjel lefelé HBC\No Vulnerable IOS javítás) | This option is useful for people who are having trouble getting the HackMii Installer to work or have an upside down homebrew channel.                                                                                                                         |
| AW = Abstinence Wizard (Nem-permanens Wii hackek)                           | This option allows you to run homebrew on your Wii without making any permanent modifications to the system NAND.                                                                                                                                              |
...
| L = Letöltési sor betöltése                                                 | This option loads bundled or previously saved download queues.                                                                                                                                                                                                 |
