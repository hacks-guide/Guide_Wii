...
1. Go to `Page 2`, then click on `Internet`.
    ...
    + If you get the normal User Agreements, your ISP blocks the use of custom DNS. Please [use another exploit](get-started). Try another connection, or [use another exploit](get-started).
