...
2. Select the path to the ISO or WBFS file on your USB drive, and select the USB Loader you use. The other options should be fine the way they are.  The other options should be fine the way they are. The other options should be fine the way they are.
