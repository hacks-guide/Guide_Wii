...
In order for Wii loader to function properly, you must have the latest cIOS installed. Por favor, consulte [este guia](cios) para obter instruções caso você esteja no Wii, e [este guia](cios-mini) caso você esteja no Wii mini.
{: .notice--warning}
