...
You can join [the Nintendo Homebrew discord server](https://discord.gg/C29hYvh) for support.
...
In order to check the reason for the error, please visit the [Wiimmfi error page](https://wiimmfi.de/error).
...
For USB devices, FAT32 is also recommended, although users should be aware of FAT32 limitations which only allow volumes up to 2TB in size. WBFS was a previously used file system for Wii game backups - today, it is outdated and should not be used.
{: .notice--info}
...
+ General Homebrew: For homebrew, the average user would want 1GB or more of space.
