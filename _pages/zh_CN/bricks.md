...
#### 解决方案
要解决此问题，请通过 Priiloader 打开 HBC 并访问 MyMenuifyMod 以安装默认主题。 Alternatively, go into [YAWM ModMii Edition](yawmme) and install the CORRECT default Wii Menu WAD for your region and version.
