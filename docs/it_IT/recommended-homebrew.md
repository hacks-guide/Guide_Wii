...
| Homebrew                                                       | Descrizione                                                                                                                                                                                                                                                                                                  |
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [AnyRegion Changer ME](https://oscwii.org/library/app/ARCME)   | Un'utilità che può aiutare a cambiare la regione della console. Nonostante sia uno strumento potente, può anche causare brick seri se non sai cosa stai facendo.                                                                                                             |
...
| [WiiMC-SS](https://oscwii.org/library/app/WiiMC-SS)            | Una versione modificata e aggiornata di WiiMC. Trasforma la tua console Wii in un vero e proprio centro multimediale, con la possibilità di ascoltare musica, guardare video, riprodurre DVD e altro ancora.                                                                 |
...
| [FCE Ultra RX (NES/Famicom)](https://oscwii.org/library/app/fceurx)               | Un fork di FCE Ultra GX, un emulatore di Nintendo Entertainment System/Famicom, con funzioni aggiuntive e miglioramenti alle prestazioni.                                                                                     |
...
| [WiiMednafen (più sistemi)](https://oscwii.org/library/app/wiimednafen)           | Un port di Mednafen, un emulatore multisistema, per Wii. Questa versione supporta anche le console meno conosciute, come Neo Geo Pocket, TurboGrafx 16/PC Engine (CD) e Bandai Wonderswan. |
...
**Clicca qui sotto per unirti al server Discord di Nintendo Homebrew (in inglese) per assistenza e altro ancora.**

[Server Discord di Nintendo Homebrew](https://discord.gg/C29hYvh){.btn .btn-solid}
...
**Clicca qui sotto per unirti al server Discord di Wii mini Hacking (in inglese) per supporto mirato e altro ancora.**

[Server Discord di Wii mini Hacking](https://discord.gg/6ryxnkS){.btn .btn-solid}
