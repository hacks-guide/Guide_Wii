...
1. Download the Open Shop Channel [on the OSC website](https://oscwii.org/library/app/homebrew_browser) for usage in Dolphin. In alternativa, puoi ottenere OSCDL ed eseguire questo processo manualmente.
