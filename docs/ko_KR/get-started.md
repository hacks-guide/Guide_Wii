...
| Wii U (vWii) | 윈도우 PC를 사용할 수 있는 경우:<br> 자동 설정: [ModMii](modmii)로 진행하세요.<br> 이미 Wii U를 개조한 경우:<br> [vWii 개조](vwii-homebrew-channel)로 진행하세요.<br> Wii U를 개조하지 않았지만 개조하고 싶은 경우:<br> [Wii U 개조](https://wiiu.hacks.guide)로 진행하세요.<br> Wii U를 개조하고 싶지 않은 경우:<br> [Wii U 개조 없이 vWii 개조](wiiu-nand-dumper)로 진행 |
