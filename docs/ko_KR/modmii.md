...
5. 콘솔을 개조하는 데 사용할 익스플로잇을 선택하세요. Wii를 사용 중이시라면, SD 카드가 있는 경우 Wilbrand를 사용하시는 것을 추천합니다. vWii 모딩만을 위해서는 브라우저 사용을 권장합니다.
...
9. 세 가지 테마 효과 중에서 선택하여 사용자 지정 Wii 메뉴 테마를 설치할지 여부를 선택하세요. 각 효과는 Wii 채널 위에 마우스를 올렸을 때 윤곽선이 얼마나 회전하는지에 대한 내용을 다룹니다.
