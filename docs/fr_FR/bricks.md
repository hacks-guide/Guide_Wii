...
- {: .notice--danger} Error 003 Error 003 See [Korean Kii/Error 003 brick](bricks#error-003-brick).
...
If you don't have Priiloader, Maintenance mode may be worth a try. Hold down `+` and `-` on the Health and Safety screen.
