...
7. Insérez votre carte SD ou votre clé USB dans votre ordinateur.
...
- Family Edition Wiis CANNOT restore NAND backups without hardware modification. Ceci est dû à l'absence de ports GameCube qui sont requis sur les Wii non-boot2 pour entrer le code de confirmation de restauration.
