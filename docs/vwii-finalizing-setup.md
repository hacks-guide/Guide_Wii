...
WiiWare 4:3 DB Patcher is a homebrew app that patches the vWii's 4:3 aspect ratio database, this allows the use of the 16:9 aspect ratio in the Everybody Votes and Mii Contest/Check Mii Out Channels.
