...
1. Copy the contents of the downloaded Aroma *`.zip`* files to the root of your SD Card.
...
1. When the process is completed, power off your Wii U, eject your SD Card from your Wii U, and plug it into your PC.
