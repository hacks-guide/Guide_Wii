...
**Homebrew** refers to software that was not authorized by the original creator of a piece of hardware - in this case, Nintendo. <a href="https://en.wikipedia.org/wiki/Homebrew_(video_games)"><strong x-id="1">Homebrew</strong></a> refers to software not authorized by Nintendo. This can include games, utilities, emulators and much more! In order to gain the ability to run homebrew on the Wii, the console must first be modified to run unsigned code.
