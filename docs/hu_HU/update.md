...
7. Ez most három könyvtárat kell tartalmazzon a title ID-jukkal a letöltött IOS és Wii menü fájloknak.

   ![](/images/desktop-apps/nusget/nusget-folder-update.png)
8. Menj azokba a könyvtárakba, ahol titleID megegyezik a fentiekkel és keresd meg mindegyikben az WAD fájlt. Ezeket ki kell másolnod egy `wad` nevű mappába az SD kártyádon vagy USB drive-odon. Az eredménynek az alábbi fájlokat kell jelentenie a mappában:

   ![](/images/desktop-apps/nusget/nusget-copy-wiimenu-sd.png)
9. Ha felmásoltad mind a 3 WAD fájlt, add ki az SD kártyád/USB drive-od a PC-ből és tedd vissza a Wii-odba.
