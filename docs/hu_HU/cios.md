...
Ha képes vagy csatlakoztatni a vWii-odat az internetre, átugorgathatsz a [II. részre](cios#section-ii---installing-1).
...
5. Ismételd meg a fenti lépéseket az `IOS 56 (v5918)`, `IOS 57 (v6175)` és az `IOS 58 (v6432)` beszerzéséhez is.
...
8. Lépj be mind a négy könyvtárba és keresd meg az `IOS-XX-vXXXX-vWii.wad` fájlt mindegyikben.
...
10. Biztosítsd, hogy minden WAD fájl úgy nevezett mint a listában alább, a d2x-cios-installer-vwii-jal kompatiblitáshoz:
