...
1. Insert your SD card or USB drive into your Wii, and go to LibreShop. LibreShop should now display.
...
1. Click the hard drive icon on the bottom left of the app to select your drive. Select the root of the drive (e.g. `E:\`), not the "wbfs" or "games" folder. If you have not already done so, click the shop icon to open the Open Shop Channel frontend.

    ![](/images/desktop-apps/TWBM/twbm-osc-home.png)

1. Find an application that you would like to obtain, and press the `Install app` button. Alternatively, you can send the app directly to your Wii (this requires that your computer and Wii be on the same network).

    ![](/images/desktop-apps/TWBM/twbm-osc-search.png)

1. A dialog box will pop-up asking you if you would like to install the application. Press `Yes`. Once the installation has finished, a message will appear in the bottom right of the application indicating that the app was installed.
