...
7. Visit <a href="https://please.hackmii.com">please.hackmii.com</a>, input your Wii MAC and region, complete the CAPTCHA, ensure <code>Bundle the HackMii Installer for me!</code> is checked, and cut either wire.
...
16. The exploit will download the HackMii Installer so you can continue.
