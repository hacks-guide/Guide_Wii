...
[WiiConnect24](https://wikipedia.org/wiki/WiiConnect24) was a service that allowed users with Internet connected Wiis to view the weather and news, send messages to friends, participate in Mii contests, and more. WiiConnect24 fue descontinuado el 27 de Junio del 2013. Although discontinued, there is a third party service known as WiiLink which restores this functionality.
