...
8. Select whether or not you would like to install any of the listed channels. This is optional.
...
3. Drag and drop the `syscheck.csv` file from Windows Explorer into the window. This will paste the location of the file, from which you can press Enter.
