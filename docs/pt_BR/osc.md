...
3. Find an application that you would like to obtain, and press the `Install app` button. Como alternativa, você pode enviar o aplicativo diretamente para o seu Wii (requer que seu computador e Wii estejam na mesma rede).
...
1. Find an application that you would like to obtain, and press the Download button. Como alternativa, você pode enviar o aplicativo diretamente para o seu Wii (requer que seu computador e Wii estejam na mesma rede).
...
3. Insira seu cartão SD ou drive USB no seu Wii, e vá para o Homebrew Channel. Seus homebrews baixados agora devem ser exibidos.
...
1. Once OSCDL is open, find an application that you would like to obtain, and press the Download button. Como alternativa, você pode enviar o aplicativo diretamente para o seu Wii (requer que seu computador e Wii estejam na mesma rede).
