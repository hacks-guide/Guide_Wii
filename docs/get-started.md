...
| ----------------- | ------------------- |
| Wii/Wii Family Edition  | If you can use a Windows PC:<br> Automatic Setup — Proceed to [ModMii](modmii)<br>---------------------------------------------------<br> If you can use an SD card:<br> Manual Setup — Proceed to [Wilbrand](wilbrand)<br>---------------------------------------------------<br> If you cannot use an SD card:<br> Manual Setup — Proceed to [str2hax](str2hax)<br> |
| Wii mini | Manual Setup — Proceed to [Bluebomb](bluebomb) |
| Wii U (vWii)  | If you can use a Windows PC:<br> Automatic Setup — Proceed to [ModMii](modmii)<br>---------------------------------------------------<br> If you have not modded the Wii U, but want to:<br> Proceed to [Modding the Wii U](https://wiiu.hacks.guide)<br>---------------------------------------------------<br> If you have already modded your Wii U:<br> Proceed to [Modding the vWii](vwii-homebrew-channel)<br>---------------------------------------------------<br> If you do not want to mod the Wii U:<br> Proceed to [Modding the vWii Without Wii U Mods](wiiu-nand-dumper) |
